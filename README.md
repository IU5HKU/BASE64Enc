# BASE64Enc
A poor man (but fully functional) Base64 files encoder in plain C, compile with every compiler you want.
...
<html>
  <head>
    ...
    <title>Embedded Base64 icon</title>
  </head>
  <style>
    button { repeat-x center;}
  </style>
<body>
